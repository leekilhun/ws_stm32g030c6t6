...
public:
  ...
  inline void ProcessCmd(CMD::uart_cmd::packet_st &data)
  {
    ...
    case cmd_t::CMD_CTRL_IO_OUT:
    {
      ...
      uint16_t io_reg_data = 0;
      uint8_t idx = 0;
      idx = ret_data(idx, io_reg_data);
      m_cfg.ptr_io->SetOutputReg(LoWORD(io_reg_data), ap_io::bank_main_1616);
      m_cfg.ptr_io->SetOutputReg(HiWORD(io_reg_data), ap_io::bank_ext_1616);
