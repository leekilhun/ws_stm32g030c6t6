...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : HX7111_DT_Pin */
  GPIO_InitStruct.Pin = HX7111_DT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(HX7111_DT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : IO_IN_6_Pin IO_IN_7_Pin IO_IN_8_Pin IO_IN_9_Pin
                           IO_IN_10_Pin IO_IN_11_Pin IO_IN_12_Pin IO_IN_13_Pin
                           IO_IN_14_Pin */
  GPIO_InitStruct.Pin = IO_IN_6_Pin|IO_IN_7_Pin|IO_IN_8_Pin|IO_IN_9_Pin
                          |IO_IN_10_Pin|IO_IN_11_Pin|IO_IN_12_Pin|IO_IN_13_Pin
                          |IO_IN_14_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
