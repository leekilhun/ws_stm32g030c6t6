...
struct ap_reg
{
  ...
  union AP_STATE_REG
  {
    ...
    AP_STATE_REG &operator=(uint16_t data)
    {
      ap_state = data;
      return *this;
    }
  ...
  union AP_OPT_REG
  {
    ...
    AP_OPT_REG &operator=(uint16_t data)
    {
      ap_option = data;
      return *this;
    }
  ...
  union AP_ERR_REG
  {
    ...
    AP_ERR_REG &operator=(uint32_t data)
    {
      ap_error = data;
      return *this;
    }
