...
#define IO_OUT_12_Pin GPIO_PIN_15
#define IO_OUT_12_GPIO_Port GPIOA
#define IO_OUT_11_Pin GPIO_PIN_0
#define IO_OUT_11_GPIO_Port GPIOD
#define IO_OUT_10_Pin GPIO_PIN_1
#define IO_OUT_10_GPIO_Port GPIOD
#define IO_OUT_9_Pin GPIO_PIN_2
#define IO_OUT_9_GPIO_Port GPIOD
#define IO_OUT_8_Pin GPIO_PIN_3
#define IO_OUT_8_GPIO_Port GPIOD
#define IO_OUT_7_Pin GPIO_PIN_3
#define IO_OUT_7_GPIO_Port GPIOB
#define IO_OUT_6_Pin GPIO_PIN_4
#define IO_OUT_6_GPIO_Port GPIOB
#define IO_OUT_5_Pin GPIO_PIN_5
#define IO_OUT_5_GPIO_Port GPIOB
#define IO_OUT_4_Pin GPIO_PIN_8
#define IO_OUT_4_GPIO_Port GPIOB
#define IO_OUT_3_Pin GPIO_PIN_9
